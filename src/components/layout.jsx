...
export default function Layout({ pageName, children }) {
  ...
  return (
    <div className={viewMode === "dark" ? "bg-dark text-light" : ""} style={{ transition: 'background-color 0.2s linear' }}>
      <header className="container py-3 py-lg-5 text-center d-flex justify-content-between" id="main-header">
        ...
        <div className="form-check form-switch d-flex align-items-center">
          ...
          <label className="ms-3 form-check-label" for="toggleViewMode">
            {viewMode === "dark" ?
              <svg xmlns="http://www.w3.org/2000/svg" width={iconSize} height={iconSize} fill="currentColor" className="bi bi-brightness-high text-yellow" viewBox="0 0 16 16">
              ...
              :
              <svg xmlns="http://www.w3.org/2000/svg" width={iconSize} height={iconSize} fill="currentColor" className="bi bi-moon-stars text-secondary-emphasis" viewBox="0 0 16 16">
      ...
      <footer className="container text-center pb-5 text-warning">
