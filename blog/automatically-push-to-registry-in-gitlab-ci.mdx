...
<img class="img-center" src="/assets/images/gitlab-ci/pipeline-success-on-pushing-docker-image-to-ci.png" alt="A successful pipeline after pushing a new tag to the gitlab repository"/>
...
<img class="img-center" src="/assets/images/gitlab-ci/pushing-your-projects-docker-image-to-your-gitlab-registry.png" alt="A list of recently receated docker images in the gitlab container registry" />
